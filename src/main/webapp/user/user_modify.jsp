			...
			<table>
				...
				<tr>
					<td>
						...
						<span class = "noti">*영어 대문자,소문자 8글자 이상 10글자 이하</span>
					</td>
						
				</tr>
				<tr>
					<td><input type="radio" name="gender" value="f" ${vo.gender == 'f' ? 'checked' : ''}>
						여자 <input type="radio" name="gender" value="m" ${vo.gender == 'm' ? 'checked' : ''}> 남자</td>
				</tr>
				<tr>
